    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand headerFont text-lg"><strong></strong></a>
        </div>
...
<?php
	...
	$sql="SELECT * FROM db_ov.tbl_admin WHERE admin_password='".$old."'";
	$query= mysqli_query($sql, $conn);
	$rows= mysqli_num_rows($query);
	if($rows==1)
	{
		// Given Password is Valid
		$sql="UPDATE db_ov.tbl_admin SET admin_password='$new' WHERE admin_username='admin'"; // =============EDIT *SESSSION_SUERNAME *
