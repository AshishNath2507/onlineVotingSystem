        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
             ...
             <li><a href="nomination.html"><span class="subFont"><strong>Nomination's List</strong></span></a></li>
              <li><a href="uview.php"><span class=""><strong>Voters list</strong></span></a></li>
          ...
          <span class="normalFont"><a href="cpanel.php" class="btn btn-success navbar-right navbar-btn"><strong>EXIT</strong></a></span></button>
        </div>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                $db = mysqli_select_db($connection, 'db_ov');
